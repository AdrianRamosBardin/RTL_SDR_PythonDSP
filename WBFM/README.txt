...
Implementing the processing in the callback function will also allow for real time audio stream, I really ejoy listening to 'Cadena SER' but I may use this to make a crude real time analog video link for a long range rocket.
